...
namespace OpenVinoSharp.Extensions.result
{
    ...
    public class SegData : DetData, IResultData
    {
        ...
        public SegData(int index, string lable, float score, Rectangle box, Mat mask)
        {
            this.index = index;
            this.lable = lable;
            this.score = score;
        ...
        /// <param name="box">Target segmentation recognition result  box.</param>
        /// <param name="mask">Target segmentation recognition result split region.</param>
        public SegData(int index, float score, Rectangle box, Mat mask)
    ...
    public class SegResult : Result<SegData>
    {
        ...
        /// <param name="box">Target segmentation recognition result  box.</param>
        /// <param name="mask">Target segmentation recognition result split region.</param>
        public void add(int index, float score, Rectangle box, Mat mask)
        {
        ...
        /// <param name="box">Target segmentation recognition result  box.</param>
        /// <param name="mask">Target segmentation recognition result split region.</param>
        public void add(int index, string lable, float score, Rectangle box, Mat mask)
        {
